...
export const strings = {
  kh: {
    ...
    auth: {
      ...
      errExpiredLink: 'តំណភ្ជាប់នេះលែងអាចប្រើបានទៀតហើយ ឬអស់សុពលភាព។ សូមស្នើសុំតំណភ្ជាប់ថ្មី។',
    ...
    resetPassword: {
      ...
      verifying: 'កំពុងផ្ទៀងផ្ទាត់តំណភ្ជាប់...',
      subPrefix: 'កំណត់ពាក្យសម្ងាត់ថ្មីសម្រាប់',
  ...
  en: {
    ...
    auth: {
      ...
      errExpiredLink: 'This link is invalid or has expired. Please request a new one.',
    ...
    resetPassword: {
      ...
      subPrefix: 'Set a new password for',
  ...
  zh: {
    ...
    auth: {
      ...
      errGeneric: '发生错误，请重试。',
      errNoAccount: '未找到该账户。',
      errExpiredLink: '此链接无效或已过期，请重新申请。',
      forgotPassword: '忘记密码？',
      resetTitle: '重置密码',
