...
// same rule as Technical/Apps/Backtest. Once approved, lessons unlock one
// at a time in order. An admin-set permissions list (allowedLessons)
// overrides both rules entirely for a
// specific account.
