...
// same rule as the Technical track. Once approved, lessons unlock one at a
// time in order. An admin-set permissions
// list (allowedLessons) overrides both rules entirely for a specific
// account.
export default function AppsHome({ doneMap, onSelectLesson, onBack, approved, allowedLessons, isAdmin }) {
  ...
  return (
    <div className="view active" id="v-apps-home">
      ...
      {appsLessons.map((lesson, i) => {
        ...
        const prevLesson = i > 0 ? appsLessons[i - 1] : null;
